...
\set person1Id '26388279076936'
\set tag '\'Frank_Sinatra\''
 */
SELECT k2.Person2Id AS "person2.id", count(DISTINCT k1.Person2Id) AS mutualFriendCount
...
WHERE k1.Person1Id = :person1Id
  AND k1.Person1Id != k2.Person2Id
GROUP BY k2.Person2Id
ORDER BY mutualFriendCount DESC, k2.person2Id ASC
;
