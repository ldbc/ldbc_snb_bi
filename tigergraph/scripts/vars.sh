...
export TIGERGRAPH_LOAD_HEADER=true
export TIGERGRAPH_REFRESH_HEADER=false

if $TIGERGRAPH_LOAD_HEADER ; then
  TIGERGRAPH_LOAD_HEADER_STR="_with_header"
else
  TIGERGRAPH_LOAD_HEADER_STR=""
fi

if $TIGERGRAPH_REFRESH_HEADER ; then
  TIGERGRAPH_REFRESH_HEADER_STR="_with_header"
else
  TIGERGRAPH_REFRESH_HEADER_STR=""
fi
